...
(async () => {
  ...
  await fs.writeFile("posterior-uveitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("posterior-uveitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
